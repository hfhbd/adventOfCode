...
Game 5: 6 red, 1 blue, 3 green; 2 blue, 1 red, 2 green"""
        assertEquals(8, checkPossibilities(input, red = 12, green = 13, blue = 14).sum())
    }

    @Test
    fun partOne() {
        assertEquals(2795, checkPossibilities(data, red = 12, green = 13, blue = 14).sum())
    }
...
Game 4: 1 green, 3 red, 6 blue; 3 green, 6 red; 3 green, 15 blue, 14 red
Game 5: 6 red, 1 blue, 3 green; 2 blue, 1 red, 2 green"""
        assertEquals(2286, checkPossibilities2(input).sum())
    }

    @Test
    fun partTwo() {
        assertEquals(75561, checkPossibilities2(data).sum())
    }
}

private const val data = """Game 1: 4 red, 5 blue, 9 green; 7 green, 7 blue, 3 red; 16 red, 7 blue, 3 green; 11 green, 11 blue, 6 red; 12 red, 14 blue
