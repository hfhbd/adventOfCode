...
...${'$'}.*....
.664.598.."""
        assertEquals(4361, getParts(input).sum())
    }

    @Test
    fun partOne() {
        assertEquals(519444, getParts(data).sum())
    }
...
...${'$'}.*....
.664.598.."""
        assertEquals(467835, getParts2(input).map { (a, b) ->
            a * b
        }.sum())
    }
    ...
    @Test
    fun partTwo() {
        assertEquals(74528807, getParts2(data).map { (a, b) ->
            a * b
        }.sum())
    }
}
